  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" action="addSave" method="post" enctype="multipart/form-data">
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            </div><font id="APKError" style="color:red"></font>
          </div>
...
<script>
      ...
      $("#APKName").blur(function(){
        ...
        $.ajax({
            ...
            success:function(data){
            if(data==0){
                $("#APKError").html("该APK名称可用");
            }else{
                $("#APKError").html("该APK已被使用");
            }
            }
        })
      })
